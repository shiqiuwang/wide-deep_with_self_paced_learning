...
# ---------------------------加载训练的词向量-----------------------------
word_vec_dict = dict()
with open(file="./vec_dict/url_vec_location1216.txt", mode='r', encoding='utf-8') as f1:
    lines = f1.readlines()
    for line in lines:
...
all_url_vec_type0 = []
with open(file="./neg_url_tokens/domain_exist_at_nec_tokens.txt", mode='r', encoding='utf-8') as f2:
...
neg_wide_feature0 = pd.read_csv("./neg_url_widefeature/all_wide_feature_less.csv", encoding='utf-8')
...
all_url_vec_type1 = []
with open(file="./neg_url_tokens/domain_is_ip_tokens.txt", mode='r', encoding='utf-8') as f3:
    lines = f3.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
neg_wide_feature1 = pd.read_csv("./neg_url_widefeature/all_wide_feature_less.csv", encoding='utf-8')
neg_wide_feature1 = neg_wide_feature1.values[373946:390736,:]
...
all_url_vec_type2 = []
with open(file="./neg_url_tokens/real_domain_exist_at_nec_and_others_tokens.txt", mode='r', encoding='utf-8') as f4:
    lines = f4.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
neg_wide_feature2 = pd.read_csv("./neg_url_widefeature/all_wide_feature_less.csv",
                                encoding='utf-8')
neg_wide_feature2 = neg_wide_feature2.values[390736:408864,:]
...
all_url_vec_type3 = []
with open(file="./neg_url_tokens/real_domain_exist_at_others_tokens.txt", mode='r', encoding='utf-8') as f5:
    lines = f5.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
neg_wide_feature3 = pd.read_csv("./neg_url_widefeature/all_wide_feature_less.csv",
                                encoding='utf-8')
neg_wide_feature3 = neg_wide_feature3.values[408864:411569,:]
...
all_url_vec_type4 = []
with open(file="./neg_url_tokens/url_no_obvious_domain_tokens.txt", mode='r', encoding='utf-8') as f6:
    lines = f6.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
neg_wide_feature4 = pd.read_csv("./neg_url_widefeature/all_wide_feature_less.csv",
                                encoding='utf-8')
neg_wide_feature4 = neg_wide_feature4.values[411569:480000,:]
...
all_url_vec_type5 = []
with open(file="./pos_url_tokens/pos_url_tokens.txt", mode='r', encoding='utf-8') as f7:
    lines = f7.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
neg_wide_feature5 = pd.read_csv("./pos_url_widefeature/all_wide_feature_less.csv",
                                encoding='utf-8')
neg_wide_feature5 = neg_wide_feature5.values[480000:960000,:]
